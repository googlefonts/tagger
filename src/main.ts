...
import AddStaticTag from "./components/AddStaticTag.vue";
import AddVariableTag from "./components/AddVariableTag.vue";
...
Vue.component("add-static-tag", AddStaticTag);
Vue.component("add-variable-tag", AddVariableTag);
